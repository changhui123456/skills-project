...
from huaweicloudsdkas.v1 import AsClient, ListScalingPoliciesRequest
...
parser = argparse.ArgumentParser(description='查询弹性伸缩策略列表(v1)')
...
def main():
    ...
    try:
        ...
        for _ in range(MAX_PAGES):
            ...
            response = client.list_scaling_policies(request)
        ...
        print(f"as.list_scaling_policies 查询失败: {e}")
        exit(1)
