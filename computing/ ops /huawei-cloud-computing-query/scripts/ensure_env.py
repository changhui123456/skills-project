...
def print_manual_python_help():
    ...
    print("    Ubuntu  : apt update && apt install -y python3 python3-pip python3-venv")
    print("    CentOS  : yum install -y python3 python3-pip")
    print("    Fedora  : dnf install -y python3 python3-pip")
