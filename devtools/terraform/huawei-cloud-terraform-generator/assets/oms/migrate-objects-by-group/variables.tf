...
variable "group_action_type" {
  description = "The action type of the migration task group"
  type        = string
  default     = "stop"
}

variable "group_type" {
  description = "The type of the migration task group"
  type        = string
  default     = "PREFIX"
}
...
variable "group_object_overwrite_mode" {
  description = "The object overwrite mode of the migration task group"
  type        = string
  default     = "CRC64_COMPARISON_OVERWRITE"
}

variable "group_consistency_check" {
  description = "The consistency check of the migration task group"
  type        = string
  default     = "crc64"
}

variable "group_enable_requester_pays" {
  description = "The enable requester pays of the migration task group"
  type        = bool
  default     = true
}

variable "group_enable_failed_object_recording" {
  description = "The enable failed object recording of the migration task group"
  type        = bool
  default     = true
}
