...
- **encryption**: Whether object encryption is enabled, assigned by referencing the input variable object\_encryption
- **kms\_key\_id**: KMS key ID, used when object encryption is enabled
...
- [Best Practice Source Code Reference For OBS Bucket Object Uploaded with Encrypted Text](https://github.com/huaweicloud/terraform-provider-huaweicloud/tree/master/examples/obs/object-upload-with-encryption)
